...
function RenderMenu(id) {
    ...
    if (id === "header"){
        const cardTemplate = `
                <div class="logo">
                    <a href="./index.html#"><img src="logo-placeholder.png" alt="De Groene Weide Logo"></a>
                </div>
                <nav class="navbar">
                    <ul>
                ...
                <nav class="navbar-small">
                    <ul>
                        <li><a href="./index.html#"><img src="logo-placeholder.png" alt="De Groene Weide Logo"></a></li>
                        ...
                        <li><a href="./contact.html#" class="hover-underline-animation tooltip5"><i class="fa-solid fa-phone"></i><span class="tooltiptext5">Activiteiten</span></a></li>
